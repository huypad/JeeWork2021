...
namespace JeeWork_Core2021.Controllers.Wework
{
    ...
    [ApiController]
    [Route("api/tp-project")]
    [EnableCors("JeeWorkPolicy")]
    /// <summary>
    /// api quản lý we_authorize
    /// </summary>
    // [EnableCors(origins: "*", headers: "*", methods: "*")]
    public class TP_ProjectController : ControllerBase
    {
        ...
        public object List([FromQuery] QueryParams query)
        {
            ...
            try
            {
                ...
                using (DpsConnection cnn = new DpsConnection(ConnectionString))
                {
                    ...
                    SqlConditions Conds = new SqlConditions();
                    string dieukien_where = " p.disabled=0 and de.disabled = 0 and idkh = " + loginData.CustomerID + "";
                    if (!string.IsNullOrEmpty(query.filter["keyword"]))
                    {
