...
namespace JeeWork_Core2021.Controllers.Wework
{
    ...
    public class StatusDynamicController : ControllerBase
    {
        ...
        public StatusDynamicController(IOptions<JeeWorkConfig> config, IConnectionCache _cache, IConfiguration configuration, ILogger<StatusDynamicController> logger)
        {
        ...
        public async Task<object> Insert(StatusDynamicModel data)
        {
            ...
            try
            {
                ...
                using (DpsConnection cnn = new DpsConnection(ConnectionString))
                {
                    ...
                    if (data.Id_project_team > 0)
                    {
                        JeeWorkLiteController.update_position_status(data.Id_project_team, cnn, "id_project_team");
                    }
                    else
                    {
                        JeeWorkLiteController.update_position_status(data.id_department, cnn, "id_department");
                    }
        ...
        public async Task<object> dropPosition(PositionModel data)
        {
            ...
            try
            {
                ...
                using (DpsConnection cnn = new DpsConnection(ConnectionString))
                {
                    ...
                    JeeWorkLiteController.update_position_status(data.id_columnname, cnn, data.columnname);
                    cnn.EndTransaction();
                    return JsonResultCommon.ThanhCong(data);
                }
            }
        ...
        public async Task<object> dropPositiontemplate(PositionTemplateModel data)
        {
            ...
            try
            {
                ...
                using (DpsConnection cnn = new DpsConnection(ConnectionString))
                {
                    ...
                    JeeWorkLiteController.update_position_status_template(data.templateid, cnn);
                    cnn.EndTransaction();
                    return JsonResultCommon.ThanhCong(data);
                }
            }
        ...
        public BaseModel<object> Delete(long id)
        {
            ...
            try
            {
                ...
                using (DpsConnection cnn = new DpsConnection(ConnectionString))
                {
                    ...
                    JeeWorkLiteController.update_position_status(id_project_team, cnn, "id_project_team");
                    cnn.EndTransaction();
