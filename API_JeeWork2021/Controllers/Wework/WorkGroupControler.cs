...
namespace JeeWork_Core2021.Controllers.Wework
{
    ...
    public class WorkGroupController : ControllerBase
    {
        ...
        public WorkGroupController(IOptions<JeeWorkConfig> config, IHostingEnvironment hostingEnvironment)
        {
...
left join (select count(*) as tong, COUNT(CASE WHEN w.status=2 THEN 1 END) as ht,w.id_group from v_wework w group by w.id_group) w on g.id_row=w.id_group
