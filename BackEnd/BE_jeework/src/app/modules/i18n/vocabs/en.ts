...
export const locale = {
	...
	data: {
		...
		template: {
			...
			deletelib: "Delete template",
			automations: "Automations",
			cancel:'Cancel',
			chooseadate: "Choose a date",
			customfield: "CUSTOM FIELD",
			customnizeimportitems: "Customize import items",
			enddate: "End Date",
			enterfoldername: "Enter folder name",
			enterlistname: "Enter list name",
			enterspacename: "Enter deparment name",
			folder: "folder",
			...
			itemstoimport: "Select items to import",
			levels: "Levels",
			list: "List",
			listname: "List name",
			nosetdate: "Due and Start dates are static and will be imported exactly as is.",
			notifycreate: "Once you use a template, will be created in selected location!",
			projectdate: "Projects Date",
			remapdates: "Remap dates",
			search: "Template search",
			selectlocation: "Select location for this template to be created",
			space: "Department",
			spacename: "Department name",
			...
			types: "Types",
			usecase: "Use case",
			usetemp: "Use Template",
			usingenddate: "Use end date if you know the final project deadline.",
			usingstartdate: "Use start date if you know when your project is starting.",
			views: "Views",
			viewtype: "View type",
			collapse: "Collapse",
			seeall: "See All",
