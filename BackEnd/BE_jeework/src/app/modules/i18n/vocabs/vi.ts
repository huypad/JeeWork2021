...
export const locale = {
	...
	data: {
		...
		SubMenu: {
			...
			thaoluan_admin: 'Xem và thảo luận trong topic của dự án/phòng ban khi không phải thành viên',
			//=============Quản lý tài sản===============
			dangkyxe: 'Đăng ký xe',
		...
		work:
		{
			...
			congviec: 'Công việc',
			congviecchuahoanthanhtuthoigiantruocdo: 'CÔNG VIỆC CHƯA HOÀN THÀNH TỪ TG TRƯỚC',
			congvieccon: 'CÔNG VIỆC CON',
		...
		report: {
			...
			congviecdangthuchien: ' công việc đang thực hiện',
			chitinhcaccongviecbaocaotrongthoigianluachon: 'Chỉ tính các công việc báo cáo trong khoảng thời gian được lựa chọn',
		...
		repeated:
		{
			...
			deadline: 'Deadline (Số giờ cộng thêm). Ví dụ: 8, 8.5, để trống nếu không có deadline',
			todo: '#Đang làm',
			subtask: '#Công việc con',
			...
			forcerun_thongbaoloi: 'Không thể khởi tạo công việc lặp lại. Bạn chỉ có thể buộc chạy một tác vụ lặp lại một lần (vui lòng kiểm tra cả ngày bắt đầu và ngày kết thúc)',
