...
import { Component, OnInit, ElementRef, ViewChild, ChangeDetectionStrategy, ChangeDetectorRef, OnChanges } from '@angular/core';
...
import { TopicModel, TopicUserModel, FileUploadModel } from '../Model/Topic.model';
...
export class ViewTopicDetailComponent implements OnInit {
	// Table fields
	listNam: any[] = [];
	// Filter fields
	//Form
	...
	constructor(private _service: DiscussionsService,
