...
exports.locale = {
    ...
    data: {
        ...
        mainMenuJeeHR: {
            ...
            canhan: 'Personal',
            quanly: 'Manager',
            quanlytaisanxe: 'Property management - vehicles'
        },
        subMenuJeeHR: {
            ...
            wedepartment: 'Department management',
            ...
            wepermision: 'Permission',
            thaoluan: 'View and discuss in the topic of the project team involved',
            //=============Quản lý tài sản===============
            dangkyxe: 'Đăng ký xe',
            yeucaukhaibaots: 'Yêu cầu cấp phát tài sản'
        },
        phanquyen: {
            tieude1: 'Manage user groups',
            tieude2: 'Manage user',
            ...
            timkiem: 'Search by full name',
            phanquyen: 'Decentralization',
            danhsachnguoidung: 'List of group users',
            khoa: 'Lock',
            phanquyennhomnguoidung: 'User group decentralization',
            ...
            xem: 'Only view',
            sua: 'Repair',
            themnguoidungvaonhom: 'Add user to the group',
            phanquyenchucnang: 'Phân quyền chức năng',
            phanquyenthietlap: 'Decentralized setting',
            ID: 'ID',
            id_nhom: 'Id group'
        },
        JeeHR: {
            boqua: 'Next',
            cancel: 'Cancel',
            bancochacchanmuonxoakhong: 'Are you sure want to delete thiss data',
            // C
            ...
            choduyet: 'Pending',
            chon: 'Choose',
            choncot: 'Select column',
            choncocautochuc: 'Choose your organization structure',
            chonhinhthuc: 'Choose your form',
            chonloai: 'Select type',
            ...
            khongduocduyet: 'Not approved',
            KhongDuyet: 'Not approved',
        ...
        workprocess: {
            tieude: "Mission list",
            chitiet: 'Mission detail',
            taocongviec: 'Create a new task',
        ...
        department: {
            ...
            taomoi: 'Create department',
            chinhsua: 'Edit department',
            ten: 'Deparment name',
            chusohuu: 'Owner',
            motachusohuu: 'Dept owners can manage milestones',
            ...
            thanhvien: 'Member',
            thongke: 'Statistical',
            xemchitietduan: 'View detail projectteam',
            muctieu: 'Milestone',
            tabchinhsua: 'Edit',
            chitietmuctieu: 'Mileston detail',
        ...
        departmentandproject: {
            themtasklistmoi: 'Create a new taskList',
            themstatusmoi: 'Create a new status',
            ...
            chuabatdau: 'Not yet started',
            chuyenloaiteam: 'Change type team',
            close_status: 'Closed status',
            open_status: 'Open status',
            status: 'Status',
            cocheckists: 'Yes,keep the ckecklist',
            cocongvieccon: 'Yes,keep your job',
            cogiulaitruongdulieutuychinh: 'Yes,keep the custom field',
            confirmchange: 'Would you like switch this type of project team?',
            ...
            covagiulaihanhoanthanh: 'Yes,retaining and changin deadline?',
            department: 'Department',
            dieuchinhhanhoanthanh: 'Update deadline(Hours)',
            discuss: 'Discussions',
            dokhancap: 'Urgency',
            duanhuy: 'Cancel project',
            duankhachhang: 'The project only works with the client.',
            duannoibo: 'Interal projects',
            ...
            gannhan: 'Select tag',
            gantt: 'Tasks (Gantt)',
            giaodi: 'Delivered and overdue',
            giulaichecklists: 'Keep a checklist',
            ...
            motangangonveduan: 'Brief description of the project',
            ...
            quantrong: 'Important',
            quanlythanhvien: 'Manage member',
            reminders: 'Stop task reminders',
            tabchinhsua: 'Edit',
            tabcongviec: 'Work',
            tags: 'Tags',
            taocongviec: 'Create work',
            taonhomcongviec: 'Create work groups',
            tenduan: 'Project name',
            tenmuctieu: 'Milestone name',
            thanhvien: 'Member',
            thanhvienduan: 'Project members',
            thanhvienkhac: 'Orther members',
            thanhvienquantri: 'Admin members',
            thaydoithanhcong: 'Project/Team type changed successfully',
            themcongviec: 'Create work',
            themmoidepartment: 'Create department',
            themmoiproject: 'Create project',
            themmoiteam: 'Create group',
            thongke: 'Statistical',
            thongketheothanhvien: 'Statistics by member',
            thongtinchung: 'General overview',
            timnhanhcongviec: 'Search work',
            tuychinh: 'Setting',
            trangthaiduan: 'Project status',
            update_message: 'Update message',
            xemchitietduan: 'View projectteam details',
            yes: 'Yes',
            mieutachung: 'General description',
            tuychon: 'Orther options',
            allow_percent_done: 'Allow to complete the work percent',
            not_allow_percent_done: 'Percentage completion is not allowed',
            ...
            tuychonhienthi: 'Options to show department work',
            tonghoptheochuky: 'Tổng hợp theo chu kỳ',
            hangthang: 'Monthly',
            hangtuan: 'Weekly',
            mausachienthi: 'Dislay color',
            ...
            admins: 'Admins',
            members: 'Members',
            moreoptions: 'Add advanced options',
            lessoptions: 'Ẩn bớt các tùy chọn',
            color: 'Colors',
            chonngay: 'Selected date',
            filter: 'Filter',
            filter_tuychonhienthi: 'Display options',
            report: 'Report'
        },
        notify: {
            thongbaochuyentrang: 'Page transfer notice',
            bancomuonchuyendentrang: 'De you want to go to the page ',
            dangchuyentrang: 'Redirecting pages',
            chuanhapduthongtinbatbuoc: 'Chưa nhập đủ trường thông tin bắt buộc!',
            filedatontai: 'File already exists',
            vuilongchonthanhvien: 'Please select a member',
            vuilongchonfiledulieu: 'Please select the data file',
            importthanhcong: 'Imported successfully',
            trongso: 'trong số',
            chuacothanhviennao: 'No member',
            sodongtrentrang: 'Items per page',
            trongtongso: 'of'
        },
        filter: {
            tuan: 'WEEK',
            ...
            gansao: 'Start mark',
            giaoboitoi: 'Delivered by me',
            giaochotoi: 'Assign for me',
            giaovaduocgiao: 'Delivered and assigned',
            hienthisubtask: 'Show subtasks',
            hoanthanh: 'Completed',
            htmuon: 'Complete late',
            htsau: 'Late completed',
            htquahan: 'Done late',
            huy: 'Cancel',
            khancap: 'Urgency',
            khonghienthi: 'Not displayed',
            kichhoat: 'Actived',
            ...
            dangcho: 'Waiting...',
            congviectrong: 'Work in',
            datao: 'Created',
            capnhatcuoi: 'Last update',
            tasklist: 'Tasklist',
            setmilestone: 'Set milestone',
            tag: 'Tag',
            settag: 'Set tag',
            soluongcongviec: 'Number of tasks',
            tilehoanthanh: 'Completion rate',
            detail: 'Detail',
            tu: 'From',
            thanh: 'to',
            luc: 'at',
            ...
            khongtinhcongvieccon: 'No has child work',
            congviecdangthuchien: 'Work in process',
            congviecdahoanthanh: 'The work has been completed',
            congviecquahan: 'The work late deadline',
            congviec: 'Work',
        ...
        topic: {
            timkiemthaoluan: 'Search discusion',
            themmoithaoluan: 'Create discusion',
            chinhsua: 'Edit topic',
            xoa: 'Delete topic',
            upload: 'Upload more file',
            addfollowers: 'Add follower',
            ...
            suabinhluan: 'Edit comment content',
        ...
        summary: {
            ...
            chuacomuctieu: 'No linked milestone',
            thoigiantao: 'Creation time',
            thoigiancapnhat: 'Time to update',
            batdau: 'Start',
            deadline: 'Deadline'
        },
        work: {
            ...
            chinhsuanhomcongviec: 'Workgroup editing',
            chinhsuathongtincongviec: 'Edit work infomation',
            ...
            loai: 'Type',
            luc: 'at',
            mieutacongviec: 'Description of work',
            motacongviec: 'Description of work',
            motanhomcongviec: 'Description of workgroup',
            motathemvecongviec: 'Mô tả thêm về công việc',
            mucdouutien: 'Priority level?',
            ngaybatdaucongviec: 'Date of starting work',
            nguoigiaoviec: 'Personal assiging work',
            nhanbancongviec: 'Duplicate work',
            nhanbancongviecvaoprojectkhac: 'Duplicate work into another project',
            nhantinvoi: 'Chat with',
            noduplicate: 'No, duplicate as ordinary task',
            parent: 'Duplicate as subtask of',
            suanguoireiewer: 'Edit reviewer',
            tagtoassign: 'Tag @ to assign',
            tailieudinhkem: 'Attachments',
            taobansaococongvieckemtheo: 'Make a copy with attached work',
            tencongviec: 'Task name',
            ...
            themmoicongviec: 'Create work',
            themnhanhnhanmoi: 'Create tag',
            themnhieunguoitheodoi: 'Add more follower',
            themtailieu: 'Add file',
            thuocnhomcongviec: 'Thuộc nhóm công việc',
            time: 'Time (hh:mm, optional)',
            tongquan: 'Overview',
            upload: 'Upload attachment',
            uploadfile: 'Upload file',
            xemthongtin: 'View profile',
            xoacongviec: 'Delete work',
            xoanhomcongviec: 'Delete workgroup',
            yeucauketquacongviec: 'Request work results',
            bansaocua: 'Copies of',
            vaoduankhac: 'into another project',
            taomoicongviec: 'Create work',
            chinhsuacongviec: 'Update work',
            selectedtag: 'Selected Tag',
            selectedmilestone: 'Selected Milestone',
            dachon: 'Selected',
            nhapnoidungdegui: 'Enter the test and press the Enter key to send',
            postnow: 'Post now',
            cancel: 'Cancel',
            ...
            chinhsuanhanh: 'Quick editing',
            capnhattiendo: 'Progress update',
            quanly: 'Manage',
            tagthemthanhvien: 'Use @ to additional members',
            submit: 'Submit',
            nothanks: 'No Thanks',
            nhapcongviectuexcel: 'Improt work from Excel file',
            capnhatcongviectuexcel: 'Quickly update work from Excel file',
        ...
        report: {
            baocaocacphongban: 'Report to departments',
            baocaochitiettheothanhvien: 'Task assignments by members',
            baocaocongviec: 'REPORT ABOUT TASKS',
            baocaotonghopduan: 'General report by project',
            baocaotrangthaicongviec: 'Task breakdown by statuses',
            congviec: 'Tasks',
            congviecdahoanthanh: 'The task has been completed',
            ...
            baocaotonghoptheoduan: 'Reported by project',
            ...
            phongbanhoatdong: 'Active teams',
            clicktoupdate: 'Click to updates'
        },
        repeated: {
            tansuatlaplai: 'Task frequency *',
            cacngaylaplai: 'Repeated days * (List of all repeated days)',
            hangtuan: 'Weekly',
            hangthang: 'Monthly',
            forcerun: 'Force run',
            nhanban: 'Repeated',
            ...
            tuychonnangcao: 'MORE ADVANCED OPTIONS',
            subtask1: 'subtasks',
            todos: 'todos'
        },
        //=========================================LandingPage================================================
